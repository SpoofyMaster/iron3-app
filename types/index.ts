...
export type PrepPhase = "Base" | "Build" | "Peak" | "Taper" | "Race Week";
export type PrepSessionType = "easy" | "tempo" | "intervals" | "long" | "race_sim" | "rest" | "brick";

export interface PrepSession {
  id: string;
  day: "Mon" | "Tue" | "Wed" | "Thu" | "Fri" | "Sat" | "Sun";
  discipline: Discipline | "rest" | "brick";
  type: PrepSessionType;
  durationMin: number;
...
export interface PrepPlanWeek {
  weekNumber: number;       // 1-based from start of plan
  weekOf: string;           // ISO date of Monday of that week
  phase: PrepPhase;
  theme: string;            // e.g. "Aerobic Foundation"
